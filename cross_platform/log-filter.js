...
function processLine(line) {
  ...
  if (
    (trimmedLine.includes('Processing dist/src/') && trimmedLine.includes('.html')) ||
  ...
  const statusMessages = [
    ...
    {
      pattern: /webpack-dev-server|localhost|server running/i,
  ...
  if (
    (/error/i.test(trimmedLine) && !trimmedLine.includes('Found 0 errors')) ||
